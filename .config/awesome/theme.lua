...
local colors = night_owl_colors
local text_font = "UbuntuMono Nerd Font 11"
local icon_font = "Font Awesome 5 Pro 11"
...
theme.fg_focus      = "#011627"
theme.fg_urgent     = "#d6deeb"
theme.fg_minimize   = "#d6deeb"
